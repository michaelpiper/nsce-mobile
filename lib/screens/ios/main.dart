import 'package:NSCE/screens/ios/about.dart';
import 'package:NSCE/screens/ios/change-password.dart';
    ...
    home: FutureBuilder(
      ...
      builder: (context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasData) {
            if (snapshot.data['Role'] != null &&
                snapshot.data['Role']['name'] == "Driver") {
