...
class Bart{
  ...
  diffHuman(DateTime now){
    var diff=0;
    String text="ago";
    if(_now.year == now.year && _now.month == now.month && _now.day == now.day && _now.hour == now.hour && _now.minute == now.minute && _now.second == now.second){
      return "just now";
    }
    else if(_now.year == now.year && _now.month == now.month && _now.day == now.day && _now.hour == now.hour && _now.minute == now.minute && _now.second < now.second){
    ...
    else if(_now.year == now.year && _now.month == now.month && _now.day == now.day && _now.hour == now.hour && _now.minute < now.minute){
    ...
    else if(_now.year == now.year && _now.month == now.month && _now.day == now.day && _now.hour < now.hour){
    ...
    else if(_now.year == now.year && _now.month == now.month && _now.day < now.day){
